...
class InvalidInputException extends MyException {
  InvalidInputException({required String body})
      : super(title: "Invalid", body: body);
}

class UserAlreadyRegister extends MyException {
  UserAlreadyRegister({required String body})
      : super(title: "User Already Register 403", body: body);
}
