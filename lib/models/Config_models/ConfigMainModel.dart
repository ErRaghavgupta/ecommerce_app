...
//
//     final configMainModel = configMainModelFromJson(jsonString);

import 'dart:convert';

ConfigMainModel configMainModelFromJson(String str) => ConfigMainModel.fromJson(json.decode(str));

String configMainModelToJson(ConfigMainModel data) => json.encode(data.toJson());
...
class ConfigMainModel {
  ...
  factory ConfigMainModel.fromJson(Map<String, dynamic> json) => ConfigMainModel(
    ...
    colors: json["colors"] == null ? [] : List<MColor>.from(json["colors"]!.map((x) => MColor.fromJson(x))),
